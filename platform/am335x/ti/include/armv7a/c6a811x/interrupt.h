...
/*
** Interrupt Crossbar Events
*/
#define INT_MUX_ADC_TSC_GENINT                  (1)
/* reserved: 2 */
#define INT_MUX_UARTINT6                        (3)
#define INT_MUX_UARTINT7                        (4)
#define INT_MUX_2DHWAINT                        (5)
#define INT_MUX_2DHWAMMU                        (6)
/* reserved: 7 */
#define INT_MUX_PRUSS1_EVTOUT0                  (8)
#define INT_MUX_PRUSS1_EVTOUT1                  (9)
#define INT_MUX_PRUSS1_EVTOUT2                  (10)
#define INT_MUX_PRUSS1_EVTOUT3                  (11)
#define INT_MUX_PRUSS1_EVTOUT4                  (12)
#define INT_MUX_PRUSS1_EVTOUT5                  (13)
#define INT_MUX_PRUSS1_EVTOUT6                  (14)
#define INT_MUX_PRUSS1_EVTOUT7                  (15)
#define INT_MUX_ePWM0_TZINT                     (16)
#define INT_MUX_ePWM1_TZINT                     (17)
#define INT_MUX_ePWM2_TZINT                     (18)
#define INT_MUX_ePWM0INT                        (19)
#define INT_MUX_ePWM1INT                        (20)
#define INT_MUX_ePWM2INT                        (21)
#define INT_MUX_eQEP0INT                        (22)
#define INT_MUX_eQEP1INT                        (23)
#define INT_MUX_eQEP2INT                        (24)
#define INT_MUX_eCAP0INT                        (25)
#define INT_MUX_eCAP1INT                        (26)
#define INT_MUX_eCAP2INT                        (27)
#define INT_MUX_GPIOINT4A                       (28)
#define INT_MUX_GPIOINT4B                       (29)
#define INT_MUX_GPIOINT5A                       (30)
#define INT_MUX_GPIOINT5B                       (31)
#define INT_MUX_MB2INT                          (32)
/* reserved: 33-63 */
