 ...
 * \file     clock.h
 *
 * \brief    This file contains the function prototypes PRCM API's
...
struct clkDivider{
		...
		/**
         * \brief dvidider auto power down validity
         */
...
/**
 * \brief PLL structure definition. This will be inculded as a member of clock 
 * 	structure. If a node in clock tree is PLL the that clock will have valid PLL.
...
struct genericClock{
         ...
         * \brief Clock Name
         */
		char clkName[CLK_NAME_MAX_SIZE];
