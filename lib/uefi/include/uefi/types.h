...
EFI_ENUM(
    EFI_MEMORY_ATTRIBUTE, EfiMemoryAttribute, uint64_t,
...
EFI_ENUM(EFI_MEMORY_TYPE, EfiMemoryType, uint32_t,
         EFI_MEMORY_TYPE_RESERVED_MEMORY_TYPE, EFI_MEMORY_TYPE_LOADER_CODE,
         EFI_MEMORY_TYPE_LOADER_DATA, EFI_MEMORY_TYPE_BOOT_SERVICES_CODE,
...
EFI_ENUM(EFI_EVENT_TYPE, EfiEventType, uint32_t,
         EFI_EVENT_TYPE_TIMER = 0x80000000, EFI_EVENT_TYPE_RUNTIME = 0x40000000,
...
EFI_ENUM(EFI_TPL, EfiTpl, size_t, EFI_TPL_APPLICATION = 4, EFI_TPL_CALLBACK = 8,
         EFI_TPL_NOTIFY = 16, EFI_TPL_HIGH_LEVEL = 31);

EFI_ENUM(EFI_TIMER_DELAY, EfiTimerDelay, uint32_t, EFI_TIMER_DELAY_TIMER_CANCEL,
         EFI_TIMER_DELAY_TIMER_PERIODIC, EFI_TIMER_DELAY_TIMER_RELATIVE

);

EFI_ENUM(EFI_RESET_TYPE, EfiResetType, uint32_t, EFI_RESET_TYPE_COLD,
         EFI_RESET_TYPE_WARM, EFI_RESET_TYPE_SHUTDOWN,
...
EFI_ENUM(
    EFI_STATUS, EfiStatus, uintptr_t, EFI_STATUS_SUCCESS,
