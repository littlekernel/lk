...
static_assert(__is_trivially_destructible(IMAGE_DOS_HEADER),
              "All PE struct definitions must be POD");
...
static_assert(__is_trivially_destructible(IMAGE_FILE_HEADER),
              "All PE struct definitions must be POD");
...
static_assert(__is_trivially_destructible(IMAGE_OPTIONAL_HEADER64),
              "All PE struct definitions must be POD");
...
static_assert(__is_trivially_destructible(IMAGE_NT_HEADERS64),
              "All PE struct definitions must be POD");
