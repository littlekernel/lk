...
Note, this may fail if your system does not have `aarch64-elf-gcc` installed. To address, download from [here](https://newos.org/toolchains/aarch64-elf-14.1.0-Linux-x86_64.tar.xz), unzip, and add the extracted dir to PATH.
