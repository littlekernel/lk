...
static_assert(sizeof(struct acpi_generic_address) == 12, "");
...
static_assert(sizeof(struct acpi_madt_table) == 44, "");
...
static_assert(sizeof(struct acpi_sub_table_header) == 2, "");
...
static_assert(sizeof(struct acpi_hpet_table) == 56, "");
...
static_assert(sizeof(struct acpi_srat_table) == 48, "");
...
struct acpi_srat_processor_affinity_entry {
  struct acpi_sub_table_header header;
...
static_assert(sizeof(struct acpi_srat_processor_affinity_entry) == 16, "");
...
static_assert(sizeof(struct acpi_srat_memory_affinity_entry) == 40, "");
...
static_assert(sizeof(struct acpi_srat_processor_x2apic_affinity_entry) == 24, "");
...
static_assert(sizeof(struct acpi_madt_local_apic_entry) == 8, "");
...
static_assert(sizeof(struct acpi_madt_io_apic_entry) == 12, "");
...
static_assert(sizeof(struct acpi_madt_int_source_override_entry) == 10, "");
...
static_assert(sizeof(struct acpi_dbg2_table) == 44, "");
...
static_assert(sizeof(struct acpi_dbg2_device) == 22, "");
