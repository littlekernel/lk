...
MODULE_SRCS += $(LOCAL_DIR)/stm32f0xx_hal.c \
	...
	$(LOCAL_DIR)/stm32f0xx_ll_adc.c \
	$(LOCAL_DIR)/stm32f0xx_ll_comp.c \
	$(LOCAL_DIR)/stm32f0xx_ll_crc.c \
	$(LOCAL_DIR)/stm32f0xx_ll_crs.c \
	$(LOCAL_DIR)/stm32f0xx_ll_dac.c \
	$(LOCAL_DIR)/stm32f0xx_ll_dma.c \
	$(LOCAL_DIR)/stm32f0xx_ll_exti.c \
	$(LOCAL_DIR)/stm32f0xx_ll_gpio.c \
	$(LOCAL_DIR)/stm32f0xx_ll_i2c.c \
	$(LOCAL_DIR)/stm32f0xx_ll_pwr.c \
	$(LOCAL_DIR)/stm32f0xx_ll_rcc.c \
	$(LOCAL_DIR)/stm32f0xx_ll_rtc.c \
	$(LOCAL_DIR)/stm32f0xx_ll_spi.c \
	$(LOCAL_DIR)/stm32f0xx_ll_tim.c \
	$(LOCAL_DIR)/stm32f0xx_ll_usart.c \
	$(LOCAL_DIR)/stm32f0xx_ll_utils.c \
